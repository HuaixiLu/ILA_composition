...
assume -name issue_decode12 {(~ __START__) || (__ILA_BSG_UPSTREAM_OUT_decode_of_Output2_Send1__)}
...
assert -name variable_map_assert4 {(~ __IEND__) || (({sent_counter[0], m1.ch_0_oddr_phy.odd_r}))}
