...
assume -name issue_decode12 {(~ __START__) || (__ILA_BSG_UPSTREAM_OUT_decode_of_Output3_Send2__)}
...
assert -name variable_map_assert0 {(~ __IEND__) || (m1.io_data_r_o[7:0] == __ILA_SO_io_data_out_ch0)}
assert -name variable_map_assert1 {(~ __IEND__) || (m1.io_data_r_o[15:8] == __ILA_SO_io_data_out_ch1)}
assert -name variable_map_assert2 {(~ __IEND__) || (m1.io_valid_r_o[0] == __ILA_SO_io_valid_out)}
assert -name variable_map_assert3 {(~ __IEND__) || (({sent_counter[0], m1.ch_0_oddr_phy.odd_r}))}
