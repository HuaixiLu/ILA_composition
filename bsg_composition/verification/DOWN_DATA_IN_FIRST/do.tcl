...
assume -name start_condition20 {(~ __START__) || __ILA_BSG_DOWNSTREAM_ch_decode_of_DOWN_DATA_IN_FIRST__}
...
assert -name variable_map_assert0 {(~ __IEND__) || ((~ ((__START__) ) || (m1.ch_0_iddr_data.data_p_r[7:0] == __ILA_SO_io_data) )&&( ~ (~(__START__)&&(__IEND__) ) || (__m12__)))}
assert -name variable_map_assert1 {(~ __IEND__) || ((~ ((__START__) ) || (__m13__) )&&( ~ (~(__START__)&&(__IEND__) ) || (__m14__)))}
