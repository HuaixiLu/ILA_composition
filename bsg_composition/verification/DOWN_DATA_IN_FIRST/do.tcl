...
assume -name start_condition23 {(~ __START__) || __ILA_BSG_DOWNSTREAM_ch_decode_of_DOWN_DATA_IN_FIRST__}
assume -name start_condition24 {(~ __START__) || m1.io_clk_i == 0}
...
assert -name variable_map_assert0 {(~ __IEND__) || (m1.ch_0_iddr_data.data_p_r[7:0] == __ILA_SO_io_data)}
assert -name variable_map_assert1 {(~ __IEND__) || ((~ ((__START__) ) || (__m12__) )&&( ~ (~(__START__)&&(__IEND__) ) || (__m13__)))}
