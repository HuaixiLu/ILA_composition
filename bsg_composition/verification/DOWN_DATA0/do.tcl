...
assume -name start_condition23 {(~ __START__) || __ILA_BSG_DOWNSTREAM_ch_decode_of_DOWN_DATA0__}
assume -name start_condition24 {(~ __START__) || m1.core_clk_i == 0}
...
assert -name variable_map_assert2 {(~ __IEND__) || ((~ ((__START__) ) || (__m14__) )&&( ~ (~(__START__)&&(__IEND__) ) || (__m15__)))}
