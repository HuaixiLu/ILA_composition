...
assume -name issue_decode23 {(~ __START__) || (__ILA_BSG_DOWNSTREAM_ch_decode_of_DOWN_TOKEN_SEND__)}
...
assert -name variable_map_assert0 {(~ __IEND__) || ((~ ((__START__) ) || (__m12__) )&&( ~ (~(__START__)&&(__IEND__) ) || (__m13__)))}
