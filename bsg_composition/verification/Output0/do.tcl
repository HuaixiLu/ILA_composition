...
assume -name start_condition14 {(~ __START__) || __ILA_BSG_UPSTREAM_OUT_decode_of_Output0__}
assume -name start_condition15 {(~ __START__) || m1.ch_0_oddr_phy.ready_o == 1}
...
assert -name variable_map_assert4 {(~ __IEND__) || ((~ ((__START__) ) || (__m10__) )&&( ~ (~(__START__)&&(__IEND__) ) || (__m11__)))}
