...
assume -name issue_decode23 {(~ __START__) || (__ILA_BSG_DOWNSTREAM_ch_decode_of_DOWN_DATA1__)}
assume -name issue_valid24 {(~ __START__) || (__ILA_BSG_DOWNSTREAM_ch_valid__)}
...
assert -name variable_map_assert0 {(~ __IEND__) || ({m1.core_data_o[47:32],m1.core_data_o[15:0]}  == __ILA_SO_core_data_out)}
assert -name variable_map_assert1 {(~ __IEND__) || (__m12__)}
assert -name variable_map_assert2 {(~ __IEND__) || (__m13__)}
assert -name variable_map_assert3 {(~ __IEND__) || ((~ ((__START__) ) || (__m14__) )&&( ~ (~(__START__)&&(__IEND__) ) || (__m15__)))}
assert -name variable_map_assert4 {(~ __IEND__) || ((~ ((__START__) ) || (__m16__) )&&( ~ (~(__START__)&&(__IEND__) ) || (__m17__)))}
